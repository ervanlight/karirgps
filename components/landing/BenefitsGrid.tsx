      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
          ...
          <p className="text-ink-light text-lg">
            Bukan sekadar tes kepribadian — ini langkah konkret yang bisa langsung kamu jalani.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-4 md:gap-6">
          ...
          {/* Card 1 */}
          <div className="bg-white p-6 md:p-8 rounded-2xl border border-surface-200 shadow-sm md:col-span-1 xl:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-ink">Jalur Utama Keputusan</h3>
            </div>
            <p className="text-ink-light text-sm leading-[1.7]">
              Satu arah paling masuk akal buat kamu: Kuliah, Kerja, atau Hybrid — bukan daftar pilihan yang bikin tambah bingung.
            </p>
          </div>
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl border border-surface-200 shadow-sm md:col-span-1 xl:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-ink">Alasan Logis</h3>
            </div>
            <p className="text-ink-light text-sm leading-[1.7]">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl border border-surface-200 shadow-sm md:col-span-1 xl:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-ink">3 Rekomendasi Karir</h3>
            </div>
            <p className="text-ink-light text-sm leading-[1.7]">
          ...
          {/* Card 4 */}
          <div className="bg-white p-6 md:p-8 rounded-2xl border border-surface-200 shadow-sm md:col-span-1 xl:col-span-3">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-ink">Simulasi Risiko</h3>
            </div>
            <p className="text-ink-light text-sm leading-[1.7] max-w-lg">
              Ketahui tantangan utama dan potensi kegagalan dari opsi yang kamu pilih agar bisa bersiap lebih awal.
            </p>
          </div>

          {/* Card 5 (Premium Focus) */}
          <div className="bg-white p-6 md:p-8 rounded-2xl border border-surface-200 shadow-sm md:col-span-2 xl:col-span-3 relative overflow-hidden group hover:shadow-md transition-shadow duration-300">
            <div className="absolute top-0 right-0 w-64 h-64 bg-brand-50/50 blur-[60px] rounded-full pointer-events-none group-hover:bg-brand-100/50 transition-colors duration-700"></div>
            <div className="relative z-10 flex flex-col h-full justify-center">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-ink text-lg">Roadmap 6–12 Bulan</h3>
              </div>
              <p className="text-ink-light text-sm leading-[1.7] max-w-lg">
