    ...
    <section className="py-16 md:py-24 bg-slate-50 border-y border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-4 md:gap-6">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm md:col-span-2 xl:col-span-3 relative overflow-hidden group hover:shadow-md transition-shadow duration-300">
            ...
            <div className="relative z-10 flex flex-col h-full justify-center">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-slate-900 text-lg">Roadmap 6–12 Bulan</h3>
              </div>
              <p className="text-slate-600 text-sm leading-[1.7] max-w-lg">
